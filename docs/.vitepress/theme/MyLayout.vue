<template>
  <Layout>
    ...
    <template #doc-after>
      <div v-if="showGlslEditor">xxxx</div>
...
import './components/utils/glslEditor.js'
import './components/utils/glslEditor.css'
...
const showGlslEditor = computed(()=> {
  return !!frontmatter.value.showGlslEditor
})
</script>
